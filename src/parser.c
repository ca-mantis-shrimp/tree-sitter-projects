...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_child_project, 3),
  [35] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_child_project, 3),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_leaf_project, 4),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_leaf_project, 4),
  ...
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_project_repeat1, 2),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_project_repeat1, 2),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_project_repeat1, 2), SHIFT_REPEAT(47),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grandchild_project, 5),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grandchild_project, 5),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_child_project, 5),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_child_project, 5),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_project_repeat2, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_project_repeat2, 2),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_project_repeat2, 2), SHIFT_REPEAT(56),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_leaf_project, 5),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_leaf_project, 5),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_root_project, 5),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root_project, 5),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_great_grandchild_project_repeat1, 2),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_great_grandchild_project_repeat1, 2), SHIFT_REPEAT(54),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_great_grandchild_project_repeat1, 2),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_great_grandchild_project, 6),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_great_grandchild_project, 6),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_id, 2),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_id, 2),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3),
  ...
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section, 3),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 3),
  ...
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(62),
